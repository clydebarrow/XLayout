...
data class Layout(
    ...
    var margins: UxEdgeInsets
        get() = CxFactory.uxEdgeInsets(topMargin, leftMargin, bottomMargin, rightMargin)
        set(value) {
    ...
    class Builder() {
        ...
        fun margins(margins: UxEdgeInsets): Builder {
            if (!layout.margins.isZero)
        ...
        fun margin(value: Double): Builder {
            return margins(CxFactory.uxEdgeInsets(value, value, value, value))
        }
    ...
    internal fun resolveSize(size: CxSize, sizeMeasured: CxSize): CxSize {
